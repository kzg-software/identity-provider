...
<div class="relative min-h-screen flex flex-col items-center pt-8 sm:justify-center sm:pt-0 {{ $hasLoginBg ? 'bg-gray-900' : 'bg-gray-100' }}"
    ...
    <div class="relative w-full flex flex-col items-center px-4">
